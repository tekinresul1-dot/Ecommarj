        ...
        >
            <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-3">
                    <Link href="/giris" className="text-sm text-slate-300 hover:text-white transition-colors px-4 py-2">
                        Giriş Yap
                    </Link>
                    <Link
                        href="/ucretsiz-basla"
                ...
                <>
                    ...
                    <div className="fixed top-16 left-0 right-0 z-50 bg-navy-950/98 backdrop-blur-xl border-b border-white/5 p-6 space-y-4 animate-slide-up">
                        ...
                        <div className="pt-4 border-t border-white/5 space-y-3">
                            <Link href="/giris" className="block text-center text-slate-300 hover:text-white py-2">
                                Giriş Yap
                            </Link>
                            <Link
                                href="/ucretsiz-basla"
